...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 mb-4 "><img src="image/<?php echo $produk['foto']; ?>" class="w-100 img-thumbnail" alt=""></div>
        ...
        <!-- Ddetail produk-->
    <div class="container-fluid py-5 warna1 text-white">
        <h2 class="text-center tex-white mb-4">Produk Terkait</h2>
